...
OCR_PROMPT = (
    ...
    "Не пересказывай, не объясняй, не исправляй смысл, не добавляй факты. "
    "Сохраняй русский текст, заголовки, списки и нумерацию. Если фрагмент "
    "не читается, напиши [неразборчиво]. Не делай выводов."
)
